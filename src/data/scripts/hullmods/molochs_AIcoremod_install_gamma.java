...
/**
 * Installation hullmod for Gamma AI Core Integration.
 * Consumes a gamma core and adds the actual integration hullmod as built-in.
 */
public class molochs_AIcoremod_install_gamma extends BaseHullMod {
    ...
    public void applyEffectsAfterShipCreation(ShipAPI ship, String id) {
        ...
        if (!ship.getVariant().hasHullMod("molochs_AIcoremod_install_gamma")) {
            return;
        }
    ...
    public void advanceInCampaign(FleetMemberAPI member, float amount) {
        ...
        // Check if installation hullmod is still present
        if (!member.getVariant().hasHullMod("molochs_AIcoremod_install_gamma")) {
            return;
        }
    ...
    public boolean canBeAddedOrRemovedNow(ShipAPI ship, MarketAPI marketOrNull, CampaignUIAPI.CoreUITradeMode mode) {
        return molochs_util_misc.playerHasCommodity("gamma_core") && 
               super.canBeAddedOrRemovedNow(ship, marketOrNull, mode);
    }

    @Override
    public String getCanNotBeInstalledNowReason(ShipAPI ship, MarketAPI marketOrNull, CampaignUIAPI.CoreUITradeMode mode) {
        if (!molochs_util_misc.playerHasCommodity("gamma_core")) {
            return "You do not have the required Gamma AI core";
        }
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, ShipAPI.HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        ...
        tooltip.addPara("Consumes a Gamma AI core from your inventory and permanently integrates it into the ship as a built-in modification. The integration cannot be removed once installed.", pad, highlight, "permanently integrates", "built-in modification", "cannot be removed");
    }
}
