...
public class molochs_AIcoreRefunder_alphacore extends BaseHullMod {
    ...
    public void advanceInCampaign(FleetMemberAPI member, float amount) {
        ...
        if (member.getVariant().hasHullMod("molochs_AIcoremod_alpha")) {
