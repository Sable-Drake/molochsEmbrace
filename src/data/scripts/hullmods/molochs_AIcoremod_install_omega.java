...
/**
 * Installation hullmod for Omega AI Core Integration.
 * Consumes an omega core and adds the actual integration hullmod as built-in.
 */
public class molochs_AIcoremod_install_omega extends BaseHullMod {
    ...
    public void applyEffectsAfterShipCreation(ShipAPI ship, String id) {
        ...
        if (!molochs_settings.isOmegaMechanicEnabled()) {
            if (ship.getVariant().hasHullMod("molochs_AIcoremod_install_omega")) {
    ...
    public void advanceInCampaign(FleetMemberAPI member, float amount) {
        ...
        // Check if omega mechanics are enabled
        if (!molochs_settings.isOmegaMechanicEnabled()) {
            if (member.getVariant().hasHullMod("molochs_AIcoremod_install_omega")) {
                member.getVariant().getHullMods().remove("molochs_AIcoremod_install_omega");
            }
            return;
        }
    ...
    public boolean canBeAddedOrRemovedNow(ShipAPI ship, MarketAPI marketOrNull, CampaignUIAPI.CoreUITradeMode mode) {
        ...
        return molochs_util_misc.playerHasCommodity("omega_core") && 
    ...
    public String getCanNotBeInstalledNowReason(ShipAPI ship, MarketAPI marketOrNull, CampaignUIAPI.CoreUITradeMode mode) {
        ...
        if (!molochs_util_misc.playerHasCommodity("omega_core")) {
            return "You do not have the required Omega AI core";
        }
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, ShipAPI.HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        ...
        tooltip.addPara("Consumes an Omega AI core from your inventory and permanently integrates it into the ship as a built-in modification. The integration cannot be removed once installed.", pad, highlight, "permanently integrates", "built-in modification", "cannot be removed");
    }
}
