...
/**
 * Installation hullmod for Alpha AI Core Integration.
 * Consumes an alpha core and adds the actual integration hullmod as built-in.
 */
public class molochs_AIcoremod_install_alpha extends BaseHullMod {
    ...
    public void advanceInCampaign(FleetMemberAPI member, float amount) {
        ...
        // Check if installation hullmod is still present
        if (!member.getVariant().hasHullMod("molochs_AIcoremod_install_alpha")) {
            return;
        }
    ...
    public String getUnapplicableReason(ShipAPI ship) {
        ...
        // Check if already has an AI integration
        for (String hullmod : ship.getVariant().getHullMods()) {
            if (hullmod.equals("molochs_AIcoremod_alpha") || 
                hullmod.equals("molochs_AIcoremod_beta") ||
                hullmod.equals("molochs_AIcoremod_gamma") ||
    ...
    public boolean canBeAddedOrRemovedNow(ShipAPI ship, MarketAPI marketOrNull, CampaignUIAPI.CoreUITradeMode mode) {
        return molochs_util_misc.playerHasCommodity("alpha_core") && 
               super.canBeAddedOrRemovedNow(ship, marketOrNull, mode);
    }

    @Override
    public String getCanNotBeInstalledNowReason(ShipAPI ship, MarketAPI marketOrNull, CampaignUIAPI.CoreUITradeMode mode) {
        if (!molochs_util_misc.playerHasCommodity("alpha_core")) {
            return "You do not have the required Alpha AI core";
        }
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, ShipAPI.HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        ...
        tooltip.addPara("Consumes an Alpha AI core from your inventory and permanently integrates it into the ship as a built-in modification. The integration cannot be removed once installed.", pad, highlight, "permanently integrates", "built-in modification", "cannot be removed");
    }
}
