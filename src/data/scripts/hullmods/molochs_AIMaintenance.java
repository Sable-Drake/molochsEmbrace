...
public class molochs_AIMaintenance extends BaseHullMod {
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        ...
        LabelAPI label = tooltip.addPara("A relic of Tri-Tachyon's golden age. This ancient AI maintenance system uses advanced diagnostic algorithms to drastically reduce the amount of components that need regular replacements. The integrated next-generation flux grid optimization systems also drastically reduce the flux requirements of most fitted weapons. Unfortunately said flux grids are ill suited to powering lower tech weapons, reducing ballistic weapon range and flux cost reduction." +
                "" +
